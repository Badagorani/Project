...
namespace WireVisionInspection
{
	public partial class Form1 : DevExpress.XtraEditors.XtraForm
	{
		...
		{
			bool outboolean = true;
			if (Settings.WorkFileSetting.WorkUser.Equals(""))	outboolean = false;
			if (Settings.WorkFileSetting.WorkDay.Equals(""))	outboolean = false;
			if (Settings.WorkFileSetting.WorkTarget.Equals("")) outboolean = false;

			if (!outboolean) ShowMessage("작업", "작업자 설정이 필요합니다!", "주의");
			return outboolean;
		}
		#endregion
		#region 팝업
